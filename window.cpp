...
Window::Window(QWidget *parent): QDialog(parent)
{
    ...
    socket->bind(2323); // listen 2323 port
...
void Window::Layout() // creating UI
{
    ...
    QLabel *title = new QLabel("<h2>Client</h2>");
...
void Window::SendDatagram(int number) // methode for sending data
{
    ...
    {
       out << QString("Client: ") << request->version << request->count_methodes;
